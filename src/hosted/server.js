...
if(process.argv[1]===fileURLToPath(import.meta.url)){
 const app=await startHostedServer({directory:process.env.DATA_DIR??'.local-demo/hosted',accessCode:process.env.DEMO_ACCESS_CODE,origin:process.env.PUBLIC_ORIGIN,port:Number(process.env.PORT??8080),host:process.env.HOST??'127.0.0.1'});
