...
test('Aomi cannot expand the signer authority or skip a successful simulation',()=>{
...
test('Aomi receives ABI values without manually copying zero-padded calldata',()=>{
