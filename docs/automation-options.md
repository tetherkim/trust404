...
초기 설계 조사 문서 (2026-09-20). **아래 상태 목록은 구현 전 기록입니다. 현재 동작과 실행 방법은 [README](../README.md)를 기준으로 합니다.** 전용 지갑과 Aomi Agent + 로컬 signer 경로가 구현됐으며, Privy hosted 자동 서명 경로와는 구분합니다.
